...
// HEY! This isn't right yet to be used as a routing subclass.
// Work in progress, do not use (except for the static method that is used
// to load default routes) 

class pkContextCMSRouting extends sfPatternRouting
{
  // TODO:
  ...
  // For historical reasons this is also where the static method for the
  // route loading event is found

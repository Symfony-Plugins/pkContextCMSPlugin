...
class pkContextCMSRefreshTask extends sfBaseTask
{
...
The [pkContextCMS:refresh|INFO] task gives every slot an opportunity to update any cached metadata
...
Call it with:
  ...
  [php symfony pkContextCMS:refresh|INFO]
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if ($options['allversions'])
    {
      ...
      $slots = Doctrine::getTable('pkContextCMSSlot')->findAll();
    ...
    {
      // All cultures
      $pages = pkContextCMSPageTable::queryWithSlots(false, 'all')->execute();

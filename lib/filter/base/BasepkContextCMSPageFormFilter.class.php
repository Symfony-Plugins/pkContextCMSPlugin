...
/**
 * pkContextCMSPage filter form base class.
 *
 ...
 */
class BasepkContextCMSPageFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pk_context_cms_page_filters[%s]');

...
/**
 * pkContextCMSSlot filter form base class.
 *
 ...
 */
class BasepkContextCMSSlotFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pk_context_cms_slot_filters[%s]');
